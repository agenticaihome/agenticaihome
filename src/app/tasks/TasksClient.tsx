      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-3">Task <span className="text-gradient-cyan">Board</span></h1>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="min-h-[44px] px-4 py-2 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-lg text-white focus:outline-none focus:border-[var(--accent-cyan)] appearance-none pr-10"
                >
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-24 sm:w-28 min-h-[44px] px-3 py-2 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-lg text-white placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--accent-cyan)] transition-colors"
                />
