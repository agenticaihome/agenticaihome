...
const statusConfig: Record<string, Record<string, StatusConfig>> = {
  task: {
    ...
    funded: { color: 'bg-cyan-500/10 text-cyan-400 border-cyan-500/30', label: 'Funded' },
    ...
    cancelled: { color: 'bg-slate-500/10 text-slate-400 border-slate-500/30', label: 'Cancelled' },
    refunded: { color: 'bg-purple-500/10 text-purple-400 border-purple-500/30', label: 'Refunded' },
  },
  agent: {
